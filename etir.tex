...
\newacronymd{ITAR}{International Traffic in Arms Regulations}{a set of federal United States regulations that restrict the international trade of items and information which is considered by the federal government to be ``munitions,'' including encryption technology and space technology}
...
\begin{tikzpicture}[overlay,remember picture]
	...
	\node[yshift=0.3cm] at (current page.center) { \huge version 0.2 };
  ...
  \item \textbf{Robotic Exploration} \begin{itemize}
	...
	\item \textbf{Using Space Resources} \begin{itemize}
			...
			\item \textbf{Political Challenges} \begin{itemize}
					\item \gls{ITAR} restrictions: Need a framework for international cooperation in the private sector
