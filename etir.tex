...
\usepackage[ps2pdf,bookmarks=true,bookmarksopen,bookmarksopenlevel=1,pdfpagelayout=OneColumn]{hyperref}
\hypersetup{
    ...
    pdftitle={Space-TP ETIR 0.1},    % title
...
\begin{tikzpicture}[overlay,remember picture]
	\node[yshift=1.5cm] at (current page.center) { \includegraphics{etir0.1-page1.eps} };
\end{tikzpicture}
...
We have divided the problem space in two different ways. First, we have intersected each of the problem areas in section The qualitative
analysis of the relative importance of each of the solution domains is
presented in the form of a series of \emph{heatmaps}, according to the
following scale:\newline
...
individual physical and psychological health \cite{rosa-feedback}. Utilizing
...
\cite{rosa-feedback}. Success can be also found in the treatment of attention
