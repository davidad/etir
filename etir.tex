...
\begin{tikzpicture}[scale=0.45,>=stealth]
	\tikzstyle{stdbox} = [draw,shape=rectangle,minimum size=1em,inner xsep=0.25em,inner ysep=0.25em,font=\footnotesize];
...
digraph G {
  ratio=1;
	...
	robotic_exploration [label="Robotic Exploration"];
	science [label="Space Science"];
	education [label="Space Evangelism/Education"];
