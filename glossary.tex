...
\newglossaryentry{crystallography}{name={Crystallography},description={experimental science of determining the arrangement of atoms in solids. X-ray crystallography and electron crystallography are used to investigate protein structures in biology.}}

\newglossaryentry{3D printer}{name={3D Printer},description={a device which produces 3D objects from a bulk material, frequently by a process of layer-by-layer deposition}}

\newglossaryentry{Vint}{name={Vint Cerf},description={father of the internet}}
